...
Xvfb :99 -ac
echo 'www.bbc.co.uk' | DISPLAY=:99 groovy headless.groovy  ~/github/chrome_headless/1_selenium/chromedriver_linux64 | tee out.html | groovy biggest_image.groovy 2> /dev/null
